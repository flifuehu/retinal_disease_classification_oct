...
parser.add_argument('-en', '--exp-name', help='Experiment name')
...
TRAIN_FOLDER = 'input/' + args.exp_name + '/traintest/train'
TEST_FOLDER = 'input/' + args.exp_name + '/traintest/test'
TEST_LABELS_FILE = 'input/' + args.exp_name + '/traintest/test/test_labels.csv'
...
test_set_name = TEST_FOLDER.split(os.sep)[1]
csv_name = 'results_' + model_name + '_' + TEST_FOLDER.split(os.sep)[1] +'.csv'
        ...
        if testing_independent_dataset:
            ...
            for tl in test_labels:
                if tl[0].split('.')[0] == idx.split(os.sep)[-1:][0].split('.')[0]:
                    ...
                    test_predictions.append([tl[0], tl[1], predicted_class, prediction[0][0], prediction[0][1], is_correct])
                    csv_writer.writerow(test_predictions[-1])
